...
export const SUBSCRIPTION_MESSAGE = () => {
  return {
    subject: "Welcome to [Blog Name]! 🎉 Your Subscription is Confirmed",
    html: `
    <!DOCTYPE html>
<html>
<head>
                ...
                <div style="max-width: 600px; margin: 0 auto; padding: 20px;">
                    ...
                    <div style="background: #ffffff; border-radius: 8px; padding: 40px 20px; margin-bottom: 20px;">
                        ...
                        <div style="text-align: center; margin: 30px 0;">
                            <a href="#" style="background-color: #007bff; color: #ffffff; padding: 12px 30px; text-decoration: none; border-radius: 5px; font-weight: bold; display: inline-block;">Visit Our Blog</a>
                        </div>
                    ...
                    <div style="text-align: center; padding: 20px;">
                        ...
                        To unsubscribe, <a href="#" style="color: #007bff; text-decoration: none;">click here</a></p>
                    </div>
                </div>
            </td>
        </tr>
